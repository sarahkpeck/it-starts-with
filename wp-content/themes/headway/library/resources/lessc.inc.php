...
endif; /* !class_exists('lessc_parser') */
...
endif; /* !class_exists('lessc_formatter_classic') */
...
endif; /* !class_exists('lessc_formatter_compressed') */
...
endif; /* !class_exists('lessc_formatter_lessjs') */