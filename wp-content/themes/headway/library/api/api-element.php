...
class HeadwayElementAPI {
	...
	public static function init() {
		...
		add_action('headway_before_export_skin', array(__CLASS__, 'register_elements_hook'));
		add_action('headway_before_export_skin', array(__CLASS__, 'register_elements_instances_hook'));
	...
	public static function register_element_instance($args) {
		...
		else if ( isset(self::$elements[$item['group']][$item['element']]) )
